...
const LeasingMez = ({ route: { params } }) => {

      const navigateToScreenA = () => {
        const dataToPass = {
            parameter1: isMez,
            parameter2: isSignatureBase,
        };
        navigation.navigate('LeasingCheck', { params: dataToPass });
    };
                ...
                >
                    <View style={{ height: 500, padding: 20 }}>
                        ...
                        <AppModal isVisible={modal} onDismiss={() => setModal(false)} title="Гарын үсэг">
                            ...
                            <AppButton onPress={() => setModalVisible(false)} title={"Хадгалах"} style={Styles.bgRed} />
                        </AppModal>

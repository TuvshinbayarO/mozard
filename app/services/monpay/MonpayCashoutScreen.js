...
function MonpayCashoutScreen({ parentState, onChangeState, route: { params } }) {
  ...
  const { request: getCashout, loading } = useApi(sell.cashout);
  ...
  return (
    <AppContent>
      ...
      <KeyboardAvoidingView
        ...
        />
        {!isChecked && (
          <AppButton onPress={handlePressContinue} title="Тан код илгээх" disabled={!isdn || !amount || isdn.length < 8} />
        )}
        {isChecked && (
...
export default MonpayCashoutScreen;
